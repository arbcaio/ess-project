...
@router.get("/by-department/{department}", response_model=List[Discipline], summary="Get disciplines by department", description="Retrieve a list of disciplines from a specific department.")
def get_disciplines_by_department(department: str):
    return DisciplineService.get_disciplines_by_department(department)

@router.get("/by-professor/{professor}", response_model=List[Discipline], summary="Get disciplines by professor", description="Retrieve a list of disciplines taught by a specific professor.")
